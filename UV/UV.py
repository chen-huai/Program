...
def Cr():
        ...
        file=open('Z:/Temporary Folders/batch control record/Formaldehyde/%s.txt'%name,'a')
        file.write('BLK\n')
        file.write('BLK+DPC\n')
...
os.startfile('Z:/Temporary Folders/batch control record/Formaldehyde')
